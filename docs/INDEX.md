...
|---|---|---|---|---|---|
| F07 — Thème et langue (#7) | 2026-09-25 | `docs/superpowers/specs/2026-09-25-f07-theme-design.md` | `docs/superpowers/plans/2026-09-25-f07-theme.md` | En revue | `AppearanceProvider` + portées (D60), mode par session et par vue, `LocaleProvider`, `CategoryIcon` (chunk Tabler à la demande), vues `#/session` et `#/present` provisoires |
