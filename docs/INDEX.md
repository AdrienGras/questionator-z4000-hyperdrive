...
|---|---|---|---|---|---|
| Réorganisation de l'arborescence de `src/` (#31) | 2026-09-25 | — (ticket #31, D59) | — (migration scriptée) | En revue | `lib/`, `domain/`, `features/`, `testing/` ; kebab-case, sans barrel ; `pnpm deps` |
