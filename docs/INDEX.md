...
|---|---|---|---|---|---|
| F08 — Rendu markdown (#8, PR #37) | 2026-09-26 | `docs/superpowers/specs/2026-09-26-f08-markdown-design.md` | `docs/superpowers/plans/2026-09-26-f08-markdown.md` | Livré | `<Markdown source ui size>` (`components/markdown/`), sans HTML brut ; `CodeBlock` coloré par tokens Shiki (moteur JS, sans WASM, chargé à la demande), double thème par variables CSS ; composant seul, branché en F09/F14 (D62) |
| F07 — Thème et langue (#7, PR #34) | 2026-09-25 | `docs/superpowers/specs/2026-09-25-f07-theme-design.md` | `docs/superpowers/plans/2026-09-25-f07-theme.md` | Livré | `AppearanceProvider` + portées (D60), mode par session et par vue, `LocaleProvider`, `CategoryIcon` (chunk Tabler à la demande), vues `#/session` et `#/present` provisoires |
| Réorganisation de l'arborescence de `src/` (#31, PR #32) | 2026-09-25 | — (ticket #31, D59) | — (migration scriptée) | Livré | `lib/`, `domain/`, `features/`, `testing/` ; kebab-case, sans barrel ; `pnpm deps` |
| F06 — Création de session (#6, PR #29) | 2026-09-25 | `docs/superpowers/specs/2026-09-25-f06-creation-design.md` | `docs/superpowers/plans/2026-09-25-f06-creation.md` | Livré | Écran `/new` en deux colonnes : `src/students/` (lecture CSV PapaParse, séparateur détecté par score, en-tête dans les 5 premières lignes, préambule/doublons/colonnes en trop en avertissement, UTF-8 strict avec repli Windows-1252), `buildSession`, formulaire à nom prérempli et validateur chargé à la demande, zones de dépôt réutilisables, `DbStatusBanner` partagé ; CSV d'exemple publié (D54–D58) |
